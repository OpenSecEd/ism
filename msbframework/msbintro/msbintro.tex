...
\begin{frame}
  %Lista exempel, typ 1177(patientdata),
  %transportstyrelsen(registreringsinformation), Arbetsförmedlingen(felaktig
  %utbetalning).
\end{frame}
...
\begin{frame}{Identify and Analyse --- Introduction}
  \begin{itemize}
    \item Analyse the external contexts (business intelligence)~\footnote{Omvärldsanalys} and the organisation.
...
\subsection{Business Intelligence (Omvärldsanalys)}
\begin{frame}{Identify and Analyse --- Business Intelligence}
  \begin{itemize}
    \item Mapping 
      \begin{itemize}
...
\begin{frame}{Legal Requirements --- Business Intelligence}
  \begin{description}
